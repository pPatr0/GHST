<template>
    <div class="lg:max-w-[1460px] md:max-w-[700px] max-w-[300px] mx-auto py-20">
        <div class="flex flex-col items-center">
            <h2 class="text-4xl font-bold text-center text-primary lg:text-5xl unbounded lg:text-left">
                Odlište se i Vy!
            </h2>
